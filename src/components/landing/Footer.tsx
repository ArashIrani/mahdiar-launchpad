        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex items-center justify-center md:justify-start gap-3 mt-4">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.643-.203-.658-.643.136-.953l11.566-4.458c.537-.194 1.006.131.832.94z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="space-y-3">
              ...
              <a 
                href="mailto:info@mahdyar-taraz.ir" 
                className="flex items-center justify-center gap-2 text-muted-foreground hover:text-primary transition-colors"
              >
                <Mail className="w-4 h-4" />
                <span>info@mahdyar-taraz.ir</span>
              </a>
            </div>
          </div>
